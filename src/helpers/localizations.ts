export const localizations = {
  ...
  simple_warning: {
    ...
    ru:
      ', пройди тест, вдруг ты человек! (Отправь любое сообщение в этот чат в течение указанного времени, чтобы избежать бана)',
    it:
  ...
  digits_warning: {
    ...
    ru:
        ', пройди тест, вдруг ты человек! (Отправь решение указанной арифметической задачи в этот чат в течение указанного времени, чтобы избежать бана)',
    et:
  ...
  button_warning: {
    ...
    ru:
      ', пройди тест, вдруг ты человек! (нажми на кнопку ниже в течение указанного времени, чтобы избежать бана)',
    it:
  ...
  image_warning: {
    ...
    ru:
      ', пройди тест, вдруг ты человек! (Отправь цифры с картинки в этот чат в течение указанного времени, чтобы избежать бана)',
    et:
      ', palun saatke matemaatilise võrrandi lahendus sellele vestlusele määratud aja jooksul, muidu me kickime teid. Aitäh!',
    uk:
  ...
  deleteEntryOnKick_true: {
    ...
    ru:
      'Shieldy будет удалять сообщения о входе пользователей, проваливших капчу.',
    uk:
  ...
  deleteEntryOnKick_false: {
    ...
    ru:
      'Великолепно! Shieldy не будет удалять сообщения о входе пользователей, проваливших капчу.',
    uk:
  ...
  cas_true: {
    ...
    ru: 'Великолепно! Shieldy теперь будет использовать Combot Anti-Spam.',
  ...
  cas_false: {
    ...
    ru: 'Великолепно! Shieldy теперь не будет использовать Combot Anti-Spam.',
  ...
  underAttack_true: {
    ...
    ru:
      'Отлично! Shieldy теперь будет кикать всех, кто заходит в этот чат. Не забудьте отключить этот режим после окончания атаки при помощи команды /underAttack.',
    uk:
  ...
  underAttack_false: {
    ...
    ru: 'Отлично! Shieldy теперь не будет кикать всех, кто заходит в этот чат.',
    uk:
  ...
  noAttack_true: {
    ...
    ru:
      'Отлично! Shieldy отключён. Не забудьте снова включить его командой /noAttack.',
    hu:
  ...
  noChannelLinks_true: {
    ...
    ru:
      'Отлично! Shieldy теперь будет удалять сообщения с ссылками на Телеграм-каналы.',
    es:
  ...
  noChannelLinks_false: {
    ...
    ru:
      'Отлично! Shieldy теперь не будет удалять сообщения с ссылками на Телеграм-каналы.',
    es:
  ...
  banForFastRepliesToPosts_true: {
    ...
    ru:
      'Отлично! Shieldy будет банить (или кикать) пользователей, которые отвечают на посты вашего канала в течение 5 секунд после создания постов.',
    bg:
  ...
  banForFastRepliesToPosts_false: {
    ...
    ru:
      'Отлично! Shieldy не будет банить (или кикать) пользователей, которые отвечают на посты вашего канала в течение 5 секунд после создания постов.',
    bg:
  ...
  banNewTelegramUsers_true: {
    ...
    ru:
      'Отлично! Shieldy будет банить (или кикать) пользователей, у которых Телеграм ID больше 1 000 000 000.',
    bg:
  ...
  banNewTelegramUsers_false: {
    ru:
      'Отлично! Shieldy не будет банить (или кикать) пользователей, у которых Телеграм ID больше 1 000 000 000.',
    en:
